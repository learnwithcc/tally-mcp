/**
 * Integration tests for TallyApiClient rate limiting and retry functionality
 * These tests verify that the retry configuration is properly integrated
 */
...
describe('TallyApiClient Integration Tests', () => {
  describe('Retry Configuration Integration', () => {
    ...
    it('should have interceptors set up when retry config is provided', () => {
      ...
      // Verify interceptors object exists (they get set up in constructor)
    ...
    it('should maintain backward compatibility when no retry config is provided', () => {
      ...
      // Should still have default retry config
      ...
      // Other config should work as expected
  ...
  describe('Error Handling Configuration', () => {
    it('should have proper error types available for retry logic', () => {
      // This test verifies that all error types are properly exported and available
