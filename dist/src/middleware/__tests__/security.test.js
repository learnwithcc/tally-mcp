...
import { configureCORS, configureSecurityHeaders, customSecurityMiddleware, securityLogger, securityValidation, applySecurityMiddleware, } from '../security';
...
describe('Security Middleware', () => {
    ...
    describe('Security Validation', () => {
        ...
        it('should reject oversized payloads', async () => {
            const response = await request(app)
                .post('/upload')
                .send({ data: 'a'.repeat(2 * 1024 * 1024) });
