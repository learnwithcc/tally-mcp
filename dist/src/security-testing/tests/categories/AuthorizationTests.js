...
export class AuthorizationTests {
    constructor(target) {
        this.name = 'Authorization Security Tests';
        this.description = 'Tests for authorization controls and permission enforcement';
        this.enabled = true;
        this.target = target;
        this.tests = [
            {
                ...
                execute: async () => {
                    ...
                    try {
                        ...
                        await axios.post(`${this.target.baseUrl}/mcp`, { jsonrpc: '2.0', method: 'create_form', params: { name: 'New Form' }, id: '1' }, { headers: { 'x-api-key': apiKey.key } });
            ...
            },
            {
                ...
                execute: async () => {
                    ...
                    try {
                        ...
                        const response = await axios.post(`${this.target.baseUrl}/mcp`, { jsonrpc: '2.0', method: 'list_tools', id: '1' }, { headers: { 'x-api-key': apiKey.key } });
            ...
            },
            {
                ...
                execute: async () => {
                    ...
                    try {
                        ...
                        const readResponse = await axios.post(`${this.target.baseUrl}/mcp`, { jsonrpc: '2.0', method: 'list_forms', id: '1' }, { headers: { 'x-api-key': readKey.key } });
                        ...
                        await axios.post(`${this.target.baseUrl}/mcp`, { jsonrpc: '2.0', method: 'list_forms', id: '1' }, { headers: { 'x-api-key': noReadKey.key } });
