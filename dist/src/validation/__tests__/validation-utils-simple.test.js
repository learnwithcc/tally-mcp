...
describe('ValidationUtils', () => {
    ...
    describe('calculateComplexity', () => {
        ...
        it('should handle null/undefined schema', () => {
            expect(ValidationUtils.calculateComplexity(null)).toBe(0);
            expect(ValidationUtils.calculateComplexity(undefined)).toBe(0);
            expect(ValidationUtils.calculateComplexity('not an object')).toBe(0);
        });
...
//# sourceMappingURL=validation-utils-simple.test.js.map