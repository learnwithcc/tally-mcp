...
export const LogicConditionGroupSchema = z.lazy(() => z.object({
    id: z.string().optional(),
...
export const ConditionalActionConfigSchema = z.lazy(() => z.union([
...
export const ConditionalLogicSchema = z.lazy(() => z.object({
    id: z.string().optional(),
...
export const ValidationRuleSchema = z.lazy(() => z.union([
...
export const ValidationRulesSchema = z.lazy(() => z.object({
...
export const FormConfigSchema = z.lazy(() => z.object({
    title: z.string(),
    description: z.string().optional(),
...
export function deserializeFormConfig(json) {
    const data = JSON.parse(json);
    const result = FormConfigSchema.parse(data);
    return result;
}
export function getValidationRulesForQuestion(config, questionId) {
    const question = config.questions.find(q => q.id === questionId);
    return question?.validation?.rules;
}
export function getLogicRulesAffectingQuestion(config, questionId) {
