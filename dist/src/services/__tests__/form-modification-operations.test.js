...
describe('FormModificationOperations', () => {
    ...
    describe('executeOperation', () => {
        ...
        it('should handle errors gracefully', () => {
            ...
            const result = formOperations.executeOperation(command, null, null);
            expect(result.success).toBe(false);
    ...
    describe('ADD_FIELD operation', () => {
        ...
        it('should add a choice field with options', () => {
            ...
            expect((result.modifiedFormConfig?.questions[3]).options).toHaveLength(3);
            expect((result.modifiedFormConfig?.questions[3]).options[0].text).toBe('Sales');
        });
    ...
    describe('ADD_OPTION operation', () => {
        it('should add option to choice field', () => {
            ...
            const result = formOperations.executeOperation(command, sampleTallyForm, sampleFormConfig);
            expect(result.success).toBe(true);
            const choiceField = result.modifiedFormConfig?.questions[2];
...
//# sourceMappingURL=form-modification-operations.test.js.map