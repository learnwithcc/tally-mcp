...
const MockedNlpService = NlpService;
const MockedTallyApiService = TallyApiService;
const MockedFormCreationTool = FormCreationTool;
const MockedFormModificationTool = FormModificationTool;
const MockedFormSharingTool = FormSharingTool;
const MockedTeamManager = TeamManager;
const MockedSubmissionTool = SubmissionAnalysisTool;
