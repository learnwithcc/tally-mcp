...
class TeamService {
    ...
    async createTeam(request) {
        ...
        return models_1.TeamResponseSchema.parse(response);
    }
    async getTeam(teamId) {
        ...
        return models_1.TeamResponseSchema.parse({
            team: mockTeam,
            memberCount: 0,
            childTeamCount: 0,
        });
    ...
    async updateTeam(teamId, updates) {
        const validatedUpdates = models_1.UpdateTeamRequestSchema.parse(updates);
    ...
    async bulkUpdateMemberships(bulkUpdate) {
        ...
        return models_1.BulkOperationResponseSchema.parse({
            success: true,
    ...
    async getOrganizationStructure(workspaceId) {
        ...
        return models_1.OrganizationStructureSchema.parse(structure);
    }
