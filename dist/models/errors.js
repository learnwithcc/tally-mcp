...
exports.TimeoutError = exports.NetworkError = exports.ServerError = exports.RateLimitError = exports.NotFoundError = exports.BadRequestError = exports.AuthenticationError = exports.TallyApiError = void 0;
...
exports.TallyApiError = TallyApiError;
class AuthenticationError extends TallyApiError {
...
class BadRequestError extends TallyApiError {
...
class NotFoundError extends TallyApiError {
...
class RateLimitError extends TallyApiError {
...
class ServerError extends TallyApiError {
...
class NetworkError extends TallyApiError {
...
class TimeoutError extends TallyApiError {
...
function createErrorFromResponse(statusCode, statusText, headers, responseData, originalError) {
